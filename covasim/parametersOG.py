...
def make_pars(set_prognoses=False, prog_by_age=True, **kwargs):
    ...
    pars['pop_size']     = 1500e3 # Number ultimately susceptible to CoV
    ...
    pars['location']     = 'South Africa' # What location to load data from -- default Seattle

    # Simulation parameters
    pars['start_day']  = '2020-05-23' # Start day of the simulation
    pars['end_day']    = None # End day of the simulation
    pars['n_days']     = 53 # Number of days to run, if end_day isn't specified
    pars['rand_seed']  = 1 # Random seed, if None, don't reset
    pars['verbose']    = 1 # Whether or not to display information during the run -- options are 0 (silent), 1 (default), 2 (everything)

    # Rescaling parameters
    pars['pop_scale']         = 10   # Factor by which to scale the population -- e.g. pop_scale=10 with pop_size=100e3 means a population of 1 million
    ...
    pars['beta']        = 0.0085#0.0095# Beta per symptomatic contact; absolute value, calibrated
